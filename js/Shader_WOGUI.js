...
function animation() {
  ...
  mat.uniforms['decay'].value = 0.48;
  mat.uniforms['complex'].value = 0.0;
  mat.uniforms['waves'].value = 5.0;
  mat.uniforms['eqcolor'].value = 5.0;
  mat.uniforms['r_color'].value = 6.1;
  mat.uniforms['g_color'].value = 5.0;
  mat.uniforms['b_color'].value = 7.71;
  //---
